...
In their paper, they use a simple example: if two variables $Y_1, Y_2$ are correlated and standard normal, than $E(Y_1-Y_2|Y_1$ is small$)$ is less than $E(Y_1-Y_2)$.  They use this to argue that larger temperature differences (between reference stations) at extreme values are more likely.  Thus, they refute the claim that (apparently) climatologists make which is that larger temperature differences can be seen at extreme temperatures as natural phenomenon.
