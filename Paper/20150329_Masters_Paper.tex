...
\discipline{Applied Mathematics and Statistics}
...
\begin{figure}[h!]
	...
	\end{minipage}
	\caption{Temperature for Station 70219 plotted over time.  The top image is the same as the bottom but zoomed in to the last ten years to show more detail.}
	\label{fig:BasicTS}
\end{figure}
