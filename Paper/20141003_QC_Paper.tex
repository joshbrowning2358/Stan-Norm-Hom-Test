...
\begin{figure}[h!]
	\centering
	\begin{tabular}{cc}
		\includegraphics[width=.5\textwidth]{51777_Data_Unhomogenized_no_vlines} &
		\includegraphics[width=.5\textwidth]{51777_Data_Unhomogenized_zoomed_no_vlines}
	\end{tabular}
...
\begin{figure}
	\centering
	\includegraphics[width=.7\textwidth]{"51777_Data_Unhomogenized_zoomed"}
	\includegraphics[width=.7\textwidth]{"51777_Data_Homogenized_zoomed"}
